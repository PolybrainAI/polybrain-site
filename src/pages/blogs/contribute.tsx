  ...
  return (
    ...
    >
      ...
      <p>
        ...
        to Polybrain.
        <br />
        <br />A <a href="/technical">technical description</a> of Polybrain is
        provided here; it's recommended that you review this to get a high-level
        idea of how Polybrain works.
      </p>
      ...
      <p>
        ...
        <ul>
          <li>
            <a
              href="https://github.com/PolybrainAI/polybrain-site"
              target="_blank"
              rel="noreferrer"
            >
              <code>polybrain-site</code>
            </a>
            , the React code for the polybrain.xyz site
          </li>
          <li>
            <a
              href="https://github.com/PolybrainAI/polybrain-server"
              target="_blank"
              rel="noreferrer"
            >
              <code>polybrain-server</code>
            </a>
            , the server architecture for polybrain.xyz along with other API
            endpoints.
          </li>
          <li>
            <a
              href="https://github.com/PolybrainAI/polybrain-plugin"
              target="_blank"
              rel="noreferrer"
            >
              <code>polybrain-plugin</code>
            </a>
            , the chrome plugin that is added to OnShape
          </li>
          <li>
            <a
              href="https://github.com/PolybrainAI/polybrain-core"
              target="_blank"
              rel="noreferrer"
            >
              <code>polybrain-core</code>
            </a>
            , the core LLM chain for Polybrain
          </li>
          <li>
            <a
        ...
        <div className="note">
          For more details on the chain of LLMs, refer to the{" "}
          <a href="/technical">technical description</a> of Polybrain.
        </div>
        These LLM agents interface with OnPy, an unofficial Python client for
        OnShape.
      </p>

      <h1>Development Areas</h1>
      <p>
        OnPy is the primary bottleneck to OnPy; it currently limits models to a
        few primitive features (i.e., extrusions, lofts, offset-planes, etc.).
        <br />
        ...
        and execution time on code that might fail at the outset. Image
        validation is another critical area requiring development. Leveraging a
        multi-modal model's intelligence, Polybrain aims to validate that the
        generated CAD meets user expectations. If discrepancies arise, the
        code-writing LLM should autonomously rectify its response.
      </p>

      <h1>Contributing Guidelines</h1>
      <p>
        Each of the five repositories is unique in many respects. For details on
        repository-specific contributing guidelines, view the{" "}
        <code>CONTRIBUTING.md</code> file at the root of each repository.
      </p>
    </Blog>
  );
}
