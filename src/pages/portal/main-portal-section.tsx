...
import { uploadCredentials, getCredentialPreview } from "../../api/api";

type AlertFunction = (message: string) => void;
export default function MainPortalSection(props: {
  ...
  return (
    <>
      <p>
        Polybrain needs a little information to get you up and running. Follow
        these three steps and you should be on your way. If anything changes,
      ...
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            If you're reading this, that means you have successfully setup and
            logged into your account. Congratulations! You can continue onto the
            next step.
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
      <Accordion>
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            <h3>OnShape:</h3>
            <p>
              Polybrain is a chrome extension, not an OnShape cloud connected
              app. For this reason, we cannot use the OnShape OAuth system.
              Instead, you will need to provide OnShape developer keys,
              available at dev-portal.onshape.com/keys.
            </p>
            ...
            <div className="outer-iv-container">
              <div className="flexbox input-video-container">
                ...
                <div className="accordion-section-right ">
                  <div>
                    <iframe
                      src="https://youtu.be/atGUKddlyhI"
            ...
            <h3>OpenAI:</h3>
            <p>
              To avoid handling transactions, Polybrain connects directly to the
              user's OpenAI account to make LLM requests. If Polybrain is
              successful, it may eventually move to its own token system. If you
              do not have an OpenAI account, you can create one at{" "}
              <a
            ...
            <div className="outer-iv-container">
              <div className="flexbox input-video-container">
                ...
                <div className="accordion-section-right ">
                  <div>
                    <iframe
                      src="https://youtu.be/KgLIgDW9v5A"
                      title="YouTube video player"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      referrerPolicy="strict-origin-when-cross-origin"
                      allowFullScreen
